...
/** Full M3 type scale, calibrated for Expressive (high contrast between display and body). */
val TelreadTypography = Typography(
    ...
    headlineLarge = TextStyle(fontWeight = FontWeight.SemiBold, fontSize = 32.sp, lineHeight = 40.sp, letterSpacing = (-0.2).sp),
