...
### Build
- Releases are now built, signed, and published by CI on a version tag, with an automated beta channel for testers on every green build of main — no release is built on a developer machine.
